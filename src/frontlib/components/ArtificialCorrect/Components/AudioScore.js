    ...
    return (
      <div className={styles.correctScore}>
        ...
        <div className={styles.correct}>
          {formatMessage({ id: 'app.text.Deviation.correction.score', defaultMessage: '纠偏得分' })}
          ：
          {generate.map(
            (vo, index) =>
              index < 15 && (
                <span
                  ...
                  className={
                    score !== '' && Number(score * 100) === Number(vo * 100) ? styles.selected : ''
                  }
                >
                  {vo}
                </span>
          ...
          {/* <input
            ...
            onChange={this.saveScore}
          />
          分<b>(本题打分精度{current.precisionValue})</b> */}
        </div>
