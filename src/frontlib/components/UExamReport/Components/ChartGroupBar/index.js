...
function ChartGroupBar(props) {
  const { type, fields, graphData } = props;
  ...
  // #region formatFields
  // 配置能力项颜色
  const initFieldsColors = useCallback(_fields => {
  ...
  const [state, setState] = useState(() => ({
    ...
    fieldsColors: initFieldsColors(fields),
  }));
  ...
  return (
    <div className={styles.chartGroupbar}>
      <Chart
        ...
        // }}
      >
        <Axis name="className" line={tickLine} label={type === SYS_TYPE.UEXAM ? null : label} />
