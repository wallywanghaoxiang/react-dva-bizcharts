...
function PaperChartLine(props) {
  ...
  return (
    <div className={styles.paperChartLine} style={{ width: `${innerWidth - 24}px` }}>
      <Chart height={300} data={graphData} padding={[20, 20, 70, 40]} scale={scale} forceFit style={chartStyle}>
        ...
        <Axis name={difficultyText} visible={false} />
        <Tooltip
          crosshairs={{
            type: "y",
            style: {
